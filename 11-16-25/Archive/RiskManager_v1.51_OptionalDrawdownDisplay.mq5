...
#property description "3-Level Dynamic Risk Management with Integrated Trade Planning"
...
int OnInit() {
    ...
    Print("🚀 Risk Manager Indicator (Integrated Trade Planning) starting on ", _Symbol);
