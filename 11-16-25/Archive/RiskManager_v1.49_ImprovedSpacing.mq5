...
string StateToCsv(const RiskManagerState &state) {
    return StringFormat(
        "%.6f,%.6f,%.6f,%.6f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%d,%d,%d,%d,%s,%llu,%s,%d",
...
void CreateDisplay() {
    ...
    // Fixed height calculation - always use detailed mode
    int panelHeight = 263; // Increased height to accommodate dividers and all content
    ...
    // Create text labels - now using 9 labels for complete display including trade planning
    string lineNames[9] = {"_Title", "_DD", "_Risk", "_Targets", "_Detail1", "_Detail2", "_TradePlanning1", "_TradePlanning2", "_TradePlanning3"};
    for(int i = 0; i < 9; i++) {
...
void UpdateDisplay() {
    ...
    if(g_state.currentRiskPercent < g_state.maxRiskPercent && remainingToNext > 0) {
        ...
        if(g_state.currentRiskPercent == g_state.minRiskPercent) {
            ...
            ObjectSetString(0, g_labelName + "_TradePlanning1", OBJPROP_TEXT, "Total to MAX: $" + DoubleToString(totalToMax, 2) + " remaining");
        ...
        ObjectSetString(0, g_labelName + "_Detail2", OBJPROP_TEXT, "Total to MAX: $0.00");
    }
...
void DeleteDisplay() {
    ...
    // Delete all 9 text labels we use (including trade planning)
    string lineNames[9] = {"_Title", "_DD", "_Risk", "_Targets", "_Detail1", "_Detail2", "_TradePlanning1", "_TradePlanning2", "_TradePlanning3"};
    for(int i = 0; i < 9; i++) {
