...
void CreateDisplay() {
    ...
    // Create text labels - now using 10 labels for complete display including trade planning
...
void DeleteDisplay() {
    ...
    // Delete all 10 text labels we use (including trade planning and Total to MAX)
    string lineNames[10] = {"_Title", "_DD", "_Risk", "_Targets", "_Detail1", "_Detail2", "_Detail3", "_TradePlanning1", "_TradePlanning2", "_TradePlanning3"};
    for(int i = 0; i < 10; i++) {
